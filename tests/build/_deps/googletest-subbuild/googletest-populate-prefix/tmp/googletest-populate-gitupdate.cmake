...
execute_process(
  COMMAND "/usr/local/bin/git" --git-dir=.git show-ref "v1.15.2"
  WORKING_DIRECTORY "/Users/ArnavShah/Desktop/498-search-engines/lib/tests/build/_deps/googletest-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/ArnavShah/Desktop/498-search-engines/lib/tests/build/_deps/googletest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/ArnavShah/Desktop/498-search-engines/lib/tests/build/_deps/googletest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
